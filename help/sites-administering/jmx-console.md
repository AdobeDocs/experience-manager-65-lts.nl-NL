...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>true geeft aan dat asynchrone waarneming van wijzigingen in de repository wordt ondersteund. Dankzij ondersteuning voor asynchrone observaties kunnen toepassingen meldingen over elke wijziging ontvangen en hierop reageren wanneer deze zich voordoen.</td>
  </tr>
  <tr>
...
* **Type:** agent
* **Naam:** geen waarde
* **Eigenschappen:** {id="*Name*"}, waar *Naam* de waarde van het bezit van de Naam van de agent is.
