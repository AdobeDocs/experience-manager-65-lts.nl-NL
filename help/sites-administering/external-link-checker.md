...
De controleur van de Verbinding heeft verscheidene [&#x200B; configuratieopties &#x200B;](#configuring) zoals het bepalen van de bevestiging intern, toestaand bepaalde verbindingen of verbindingspatronen om van bevestiging worden weggelaten, en het herschrijven van verbindingsregels herschrijven.
...
Zie de Montages van de Configuratie OSGi van het document [&#x200B; voor meer details op hoe te om montages te veranderen OSGi.](/help/sites-deploying/osgi-configuration-settings.md)
