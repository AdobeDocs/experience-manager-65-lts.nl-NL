...
description: Leer over de Componenten van de Stichting in Adobe Experience Manager 6.5 LTS.
...
Voor meer gedetailleerde informatie over de component van de Tekst en de functionaliteit die door de Rich redacteur van de Tekst wordt verstrekt, zie de [ pagina van de Redacteur van de Tekst 0} Rich.](/help/sites-authoring/rich-text-editor.md)
