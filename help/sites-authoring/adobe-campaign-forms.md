...
1. Creeer een pagina en selecteer **het Profiel van Adobe Campaign Classic** of **Profiel van Adobe Campaign Standard** en klik **daarna**.
...
1. Op de pagina, in de **component van het Begin van de Vorm 0&rbrace;, selecteer het type van vorm het is -** Abonneren, Unsubscribe, **of** sparen Profiel **.** U kunt slechts één type per formulier hebben. U kunt [&#x200B; de inhoud van de vorm &#x200B;](#editing-form-content) nu uitgeven.
...
1. U moet een **Gecodeerde Primaire Zeer belangrijke** component op elke vorm hebben. Deze component definieert welke URL-parameter wordt gebruikt om de gecodeerde primaire sleutel van een Adobe Campaign-profiel te accepteren. Selecteer in Componenten de optie Adobe Campaign, zodat alleen die componenten zichtbaar zijn.
...
>[!NOTE]
>
>U moet een **Gecodeerde Primaire Zeer belangrijke** component op elke vorm hebben. Selecteer in Componenten de optie Adobe Campaign, zodat alleen die componenten zichtbaar zijn.
>
