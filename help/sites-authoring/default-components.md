...
Adobe Experience Manager (AEM) wordt geleverd met verschillende kant-en-klare componenten die uitgebreide functionaliteit bieden voor auteurs van websites. Zij zijn beschikbaar wanneer [&#x200B; het uitgeven van een pagina &#x200B;](/help/sites-authoring/editing-content.md). Zij groeperen hen door een belangrijkste functionele gebied genoemd een componentengroep om het filtreren te helpen.

De componenten zijn beschikbaar wanneer [&#x200B; het uitgeven van een pagina &#x200B;](/help/sites-authoring/editing-content.md). Groepeer de componenten door hun belangrijkste functionele gebied (de componentengroep) om het filtreren te helpen.

>[!NOTE]
>
>Deze sectie bespreekt slechts componenten die uit-van-de-doos in een standaardinstallatie van AEM beschikbaar zijn.
>
>Afhankelijk van uw instantie, kunt u aangepaste componenten hebben die uitdrukkelijk voor uw vereisten worden ontwikkeld. Ze kunnen zelfs dezelfde naam hebben als sommige componenten die hier worden besproken.
...
* **WijRetail**: Omvat de kerncomponenten proxied voor gebruik met de [&#x200B; WebRetail verwijzingsimplementatie &#x200B;](/help/sites-developing/we-retail.md).

* **WijRetail Commerce**: Omvat handelcomponenten zoals karretjes en productnetten
...
* Als uw pagina op het geadviseerde, moderne, editable malplaatje wordt gebaseerd, kunt u [&#x200B; het malplaatje &#x200B;](/help/sites-authoring/templates.md) veranderen, hen toelaten of onbruikbaar maken, en parameters voor specifieke componenten uitgeven.
* Als uw pagina op een statisch malplaatje gebaseerd is, kunt u [&#x200B; ontwerpwijze &#x200B;](/help/sites-authoring/default-components-designmode.md#enable-disable-components) gebruiken om hen toe te laten of onbruikbaar te maken, en parameters voor specifieke componenten uit te geven.
