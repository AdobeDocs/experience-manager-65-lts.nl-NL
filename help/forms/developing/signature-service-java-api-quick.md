---
title: Handtekeningenservice Java API QuickStart (SOAP)
...
[Snel starten (SOAP-modus): digitaal een XFA-gebaseerd formulier ondertekenen met behulp van de Java API](signature-service-java-api-quick.md#quick-start-soap-mode-digitally-signing-a-xfa-based-form-using-the-java-api)
...
AEM Forms JEE-bewerkingen kunnen worden uitgevoerd met de AEM Forms sterk getypte API en de verbindingsmodus moet worden ingesteld op SOAP.
...
## Snel starten (SOAP-modus): digitaal een XFA-gebaseerd formulier ondertekenen met behulp van de Java API {#quick-start-soap-mode-digitally-signing-a-xfa-based-form-using-the-java-api}
