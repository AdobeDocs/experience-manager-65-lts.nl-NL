---
title: PDF Service Java&amp converteren;trade; API QuickStart (SOAP)
description: Leer hoe de Convert PDF Service PDF-documenten omzet in PostScript of afbeeldingsbestanden (JPEG, JPEG 2000, PNG en TIFF).
contentOwner: admin
...
Het volgende codevoorbeeld zet een document van PDF genoemd *Loan.pdf* in een document van PostScript genoemd *Loan.ps* om. (Zie [ Converterend de Documenten van PDF in PostScript ](/help/forms/developing/converting-pdf-postscript-image-files.md#converting-pdf-documents-to-postscript).)
