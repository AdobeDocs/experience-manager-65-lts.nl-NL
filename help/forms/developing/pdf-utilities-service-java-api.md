...
description: Met de PDF Utilities-service kunt u een PDF-document converteren naar een XDP-document, een XDP-document converteren naar een PDF-document, PDF-documenteigenschappen ophalen, de opslagstijl voor een PDF-document instellen en PDF-documenten ontsmetten.
contentOwner: admin
...
De volgende snelstarthandleidingen zijn beschikbaar voor de service PDF Utilities.

[Snel starten (SOAP-modus): een PDF-document converteren naar een XDP-document met de Java API](pdf-utilities-service-java-api.md#quick-start-soap-mode-converting-a-pdf-document-to-an-xdp-document-using-the-java-api)

[Snel starten (SOAP-modus): een XDP-document converteren naar een PDF-document met de Java API](pdf-utilities-service-java-api.md#quick-start-soap-mode-converting-an-xdp-document-to-a-pdf-document-using-the-java-api)

[Snel starten (SOAP-modus): PDF-documenteigenschappen ophalen met de Java API](pdf-utilities-service-java-api.md#quick-start-soap-mode-retrieving-pdf-document-properties-using-the-java-api)

[Snel starten (SOAP-modus): de opslagstijl voor een PDF-document instellen met de Java API](pdf-utilities-service-java-api.md#quick-start-soap-mode-setting-the-save-style-for-a-pdf-document-using-the-java-api)
...
In het volgende codevoorbeeld wordt een PDF-document geconverteerd naar een XDP-document. (Zie [&#x200B; Converterend de Documenten van PDF in XDP Documenten &#x200B;](/help/forms/developing/pdf-utilities.md#converting-pdf-documents-into-xdp-documents).
...
## Snel starten (SOAP-modus): PDF-documenteigenschappen ophalen met de Java API {#quick-start-soap-mode-retrieving-pdf-document-properties-using-the-java-api}

In het volgende codevoorbeeld wordt bepaald of het document een PDF-document is en, als dat het geval is, de oudste Acrobat-versie die het kan lezen. (Zie [&#x200B; het Terugwinnen van de Eigenschappen van het Document van PDF &#x200B;](/help/forms/developing/pdf-utilities.md#retrieving-pdf-document-properties).)
...
Het volgende de codevoorbeeld van Java zet een document van PDF genoemd *Loan.pdf* in een document PDF/A-2b dat als dossier van PDF genoemd *LoanArchive.pdf* wordt bewaard. (Zie [&#x200B; Omzettend Documenten in Documenten PDF/A &#x200B;](/help/forms/developing/pdf-a-documents.md#converting-documents-to-pdf-a-documents).)
...
## Snel starten (SOAP-modus): PDF-documenten ontsmetten {#quick-start-soap-mode-sanitizing-pdf-documents}

Het volgende de codevoorbeeld van Java ontsmet een document van PDF genoemd *Loan.pdf*.
