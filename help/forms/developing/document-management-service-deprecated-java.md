...
>[!NOTE]
>
>Vanaf 5 augustus 2011 migreert Adobe Content Services ES-klanten naar de Adobe Digital Enterprise Platform Experience Services. De routekaart voor producten voor klanten die Content Services gebruiken, is om over te stappen naar de nieuwe ADEP Experience Services - Core, die een native opslagplaats voor inhoud bevat die is gebaseerd op de moderne, modulaire CRX-architectuur, die is aangeschaft tijdens de Adobe-aankoop van Day Software.

[Snel starten (SOAP-modus): Maak ruimten voor inhoudsservices met de Java API](document-management-service-deprecated-java.md#quick-start-soap-mode-create-content-services-spaces-using-the-java-api-deprecated)
...
Het volgende de codevoorbeeld van Java voegt een dossier van PDF genoemd *MortgaugeForm.pdf* aan een omslag genoemd /Company Huis/de Folder van de Test toe. De auteur- en beschrijvingskenmerken worden ingesteld. De identificatiewaarde van de nieuwe inhoud wordt geschreven aan de console.
...
Het volgende de codevoorbeeld van Java wint een dossier van PDF genoemd *MortgaugeForm.pdf* van /Company Huis terug. Het dossier van PDF wordt bewaard aan het lokale dossiersysteem en genoemd *UpdatedMortgaugeForm.pdf*.
...
Het volgende codevoorbeeld van Java beweegt een dossier van PDF genoemd *MortgaugeForm.pdf* van /Company Huis/de Folder van de Test aan /Company Huis. De identificatiewaarde van de verplaatste inhoud wordt geschreven aan de console.
