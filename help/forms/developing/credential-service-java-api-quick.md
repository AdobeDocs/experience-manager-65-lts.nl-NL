---
title: Credentieservice Java&trade; API QuickStart(SOAP)
description: Leer hoe u in AEM Forms referenties importeert en verwijdert met de Java&trade; API Quick Start (SOAP).
contentOwner: admin
