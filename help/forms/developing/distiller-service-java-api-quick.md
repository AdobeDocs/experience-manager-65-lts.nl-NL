...
description: Leer hoe de Distiller-service PostScript-, EPS- en PRN-bestanden transformeert naar PDF's, die doorgaans worden gebruikt voor het converteren van documenten naar elektronische documenten met een groot afdrukvolume.
contentOwner: admin
...
[Snel starten (SOAP-modus): een PostScript-bestand converteren naar een PDF-document met behulp van de Java](distiller-service-java-api-quick.md#quick-start-soap-mode-converting-a-postscript-file-to-a-pdf-document-using-the-java-api)
