...
U kunt een e-mailaccount opgeven voor de Forms Server, waarmee het e-mailberichten verzendt naar gebruikers en beheerders van AEM-formulieren. Deze e-mailberichten worden gebruikt om gebruikers op de hoogte te brengen van en te herinneren aan taken die zij moeten voltooien, de gebruiker op de hoogte te stellen van taken die een deadline hebben bereikt en de beheerder op de hoogte te stellen van eventuele procesfouten.

Om het verzenden van e-mailberichten tussen AEM-formulieren en gebruikers mogelijk te maken, configureert u de instellingen voor uitgaande e-mail op de pagina E-mailinstellingen. Uitgaande e-mail moet een server SMTP gebruiken.
...
1. Typ in het vak E-mailadres het e-mailadres dat u wilt gebruiken als het retouradres voor e-mailberichten die via de formulierworkflow worden verzonden.
   ...
   >[!NOTE]
   >
   >Als u Microsoft Exchange Server gebruikt en het e-mailadres een ongeldig e-mailadres is, verzendt de Microsoft Exchange-server geen e-mail naar de Distribution List. Om de kwestie op te lossen, selecteer **de Externe Communicatie** optie voor elke Lijst van de Distributie op de server van de Uitwisseling van Microsoft afzonderlijk toelaat.
...
1. Selecteer in de lijst Berichtindeling de indeling waarin het e-mailbericht wordt verzonden, HTML of Text. De standaardindeling is HTML.
...
U kunt e-mail zodanig configureren dat deze wordt verborgen voor de trackingtag DO NOT DELETE in alle e-mails die worden verzonden in een humanitair proces.
...
**bericht-gastheer** De gastheernaam van de server van de de vormentoepassing van AEM.
