...
* Verhoog de aanroepen per aanvraagconfiguratie voor grote formulieren. Zie [ Optimizing prestaties van grote en complexe vormen ](#optimizing-performance-of-large-and-complex-forms).
* Creeer [ pagina&#39;s van de douanefout die door foutenmanager ](/help/sites-developing/customizing-errorhandler-pages.md) worden getoond.
