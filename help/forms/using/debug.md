...
1. Open de logboeken om het type van fout te identificeren. Voor gedetailleerde informatie over logboeken, zie [ logboeken voor vormen HTML5 ](/help/forms/using/enable-logs.md).
...
1. Laat de cliënt zijlogboeken zoals vermeld bij [ Logboeken voor de vormen HTML5 ](/help/forms/using/enable-logs.md) toe gebruikend zuiveren optie zoals **1-a5-b5-c5**. Geef het formulier vervolgens weer en klik op Verzenden. Open browser zuivert console en controleer als er een fout is.
1. Zoek de serverlogboeken zoals vermeld bij [ Logboeken voor de vormen HTML5 ](/help/forms/using/enable-logs.md). Controleer of er tijdens de verzending een fout is opgetreden in de serverlogboeken.
