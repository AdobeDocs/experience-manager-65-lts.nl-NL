...
Voor de documentatie van AEM as a Cloud Service, zie [&#x200B; AEM Forms op Cloud Service &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-manager-cloud-service/content/forms/integrate/services/embed-adaptive-form-core-components-external-web-page).
...
* Gebruik de `[unloadAdaptiveForm](https://helpx.adobe.com/nl/experience-manager/6-3/forms/javascript-api/GuideBridge.html)` -API om het adaptieve formulier te verwijderen uit HTML DOM.
