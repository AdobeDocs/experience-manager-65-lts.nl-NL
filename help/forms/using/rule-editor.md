...
Voor de documentatie van AEM as a Cloud Service, zie [ AEM Forms op Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-rules-and-use-expressions-in-an-adaptive-form/rule-editor.html?lang=nl-NL).
...
* Een radioknoop, **bent u een bestaande klant van Geometrixx?** , dat opties Ja en Nee biedt. De waarde voor ja is **0** en Nr is **1**.

* Een tekstgebied, **de klantenidentiteitskaart van Geometrixx**, om klantenidentiteitskaart te specificeren.
