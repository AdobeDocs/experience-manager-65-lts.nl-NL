...
Als u ECMAScript gebruikt om het werkschema uit te voeren, verstrekt de het werkschemamotor van AEM waarde voor graniteWorkItem, graniteWorkflowSession, en meta-gegevensvariabelen. Deze variabelen worden als argumenten doorgegeven aan de methode WorkflowContextService.execute().
...
1. De Cliënt SDK van de Download [ Adobe ](https://repo1.maven.org/maven2/com/adobe/aemfd/aemfd-client-sdk/).
...
ECMAScript gebruikt dan de PDF Generator createPDF API om Microsoft Word-documenten (.docx) naar PDF-documenten te converteren. Voer de volgende stappen uit om het script te maken:
...
1. Open de gebruikersinterface van de AEM-workflow in een browservenster.
