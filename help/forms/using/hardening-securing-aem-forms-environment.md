---
title: AEM-formulieren verharden en beveiligen in OSGi-omgeving
...
# AEM-formulieren verharden en beveiligen in OSGi-omgeving {#hardening-and-securing-aem-forms-on-osgi-environment}
...
U kunt een externe firewall zo configureren dat bepaalde AEM Forms-URL&#39;s toegang hebben tot internet. U hebt toegang tot deze URL&#39;s nodig als u een adaptief formulier, HTML5, een brief voor correspondentiebeheer of een aanmelding bij een AEM Forms-server wilt invullen of verzenden:
...
**vergunning van het post-proces:** u kunt de vergunning gebruiken post-proces om de resultaten te bevestigen en te controleren alvorens de resultaten aan aanvrager terug te keren. U kunt ook aanvullende gegevens filteren, verwijderen en invoegen.
...
* Voeg een gebruiker toe aan een groep met workflowgebruikers om een gebruiker in staat te stellen AEM-toepassingen in postvak te gebruiken.
