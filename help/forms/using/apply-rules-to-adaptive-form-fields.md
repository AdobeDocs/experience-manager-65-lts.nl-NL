...
1. Selecteer **[!UICONTROL THEN]** in de vervolgkeuzelijst **[!UICONTROL Invoke Service]** in de instructie **[!UICONTROL Select Action]** .
...
1. Selecteer de optie **[!UICONTROL THEN]** in de optie **[!UICONTROL + Add Statement]** . Selecteer **[!UICONTROL Invoke Service]** in de vervolgkeuzelijst **[!UICONTROL Select Action]** .
...
1. Selecteer de vervolgkeuzelijst **[!UICONTROL Select State]** en selecteer **[!UICONTROL is changed]** .
   ...
   Selecteer **[!UICONTROL THEN]** in de vervolgkeuzelijst **[!UICONTROL Invoke Service]** in de instructie **[!UICONTROL Select Action]** .
