...
description: HTML5-formulieren zijn een nieuwe functie in Adobe Experience Manager 6.0 (AEM 6.0)-software die XFA-formuliersjablonen kan weergeven in HTML5-indeling.
...
* Bestaande XFA-formulieren worden in HTML5 ondersteund door alle compatibele browsers.
...
* Gebruikt een uiterst nauwkeurige SVG-tekstlay-out (SVG 1.1) die overeenkomt met de PDF-tekstlay-out.
...
Formulierontwikkelaars kunnen een XFA-sjabloon gebruiken om formulieren te genereren in PDF- en HTML5-indelingen. Deze mogelijkheid is nuttig in scenario&#39;s waarin u een grote set XFA-formulieren hebt die minimale wijzigingen vereisen om u aan te passen aan de ontwerppraktijken voor HTML5-formulieren. U kunt de bestaande XFA-formulieren weergeven op HTML5 om verschillende apparaten als doel in te stellen, waarbij PDF op basis van XFA nog niet wordt ondersteund.

## HTML5-formulieren beheren {#manage-html-forms}

AEM biedt ook één weergave voor het aanbieden en beheren van alle formuliersjablonen met de gebruikersinterface van AEM Forms. U kunt formulieren activeren, deactiveren, publiceren en hiervan een voorbeeld weergeven. Voor meer informatie, zie [ Inleiding aan het beheren van vormen ](../../forms/using/introduction-managing-forms.md).
