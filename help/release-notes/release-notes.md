...
Voor gedetailleerde instructies, zie [ de installatieinstructies van het Pak van de Dienst van AEM Forms ](https://experienceleague.adobe.com/nl/docs/experience-manager-65/content/release-notes/aem-forms-current-service-pack-installation-instructions).
