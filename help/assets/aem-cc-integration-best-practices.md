...
![ de verbindingen van Creative Cloud voor Experience Manager, beslissen welk vermogen te gebruiken ](assets/creative-connections-aem.png)
...
| Diverse - gebruiker en aanmelding | Creative Cloud-gebruiker die zich heeft aangemeld bij Creative Cloud-bureaubladtoepassing wordt herkend (SSO) | [!DNL Experience Manager] gebruiker en referenties | Gebruikers van beide oplossingen tellen mee voor de [!DNL Experience Manager] gebruikersquota. |
...
* Zie [ de Verbinding van Activa van Adobe ](https://helpx.adobe.com/enterprise/using/adobe-asset-link.html)
...
>* [ Experience Manager Desktop app beste praktijken ](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/archive/best-practices-for-v1.html)
