...
* EPS en AI transformatie die ImageMagick (`https://www.imagemagick.org/script/index.php` website) en [&#x200B; Ghostscript &#x200B;](https://www.ghostscript.com/) gebruiken.
...
1. Installeren [!DNL ImageMagick]: raadpleeg de documentatie van ImageMagick op de `https://www.imagemagick.org/script/download.php` -website.
