...
* U hebt *bestaand* **[!UICONTROL Dynamic Media Configuration]** (in **[!UICONTROL Cloud Services]**). Zie [&#x200B; een Dynamische Configuratie van Media in de Diensten van de Wolk &#x200B;](/help/assets/config-dms7.md#configuring-dynamic-media-cloud-services) creëren.
