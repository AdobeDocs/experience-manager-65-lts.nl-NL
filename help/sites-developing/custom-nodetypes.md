...
description: Adobe Experience Manager (AEM) is gebaseerd op Sling en gebruikt een JCR-opslagplaats met knooppunttypen die door beide worden aangeboden, maar AEM biedt ook een reeks aangepaste knooppunttypen
