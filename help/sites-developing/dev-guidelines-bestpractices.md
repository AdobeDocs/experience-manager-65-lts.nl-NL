...
Omdat AEM tot vele dossiers kan toegang hebben, wordt het geadviseerd dat het aantal [ open dossiers voor een proces Java™ ](/help/sites-deploying/configuring.md#open-files-in-the-java-process) uitdrukkelijk voor AEM wordt gevormd.
