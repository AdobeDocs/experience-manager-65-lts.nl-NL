...
Voor informatie over hoe te om editable malplaatjes in een project van AEM te gebruiken zie [&#x200B; Creërend een project van AEM gebruikend Lazybones &#x200B;](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/create-aem-project-structure-using-lazybones/m-p/186478?profile.language=nl).
