...
+ Sites {#sites}
   + Authoring {#authoring}
      ...
      + Paginaprestaties {#page-performance}
         + [ Inzicht van 0 Inhoud](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/authoring/siteandpage/content-insights.html?lang=nl-NL)
