...
Het huidige bereik van AI Assistant in AEM is gericht op het aanpakken van productkennisvragen voor AEM as a Cloud Service. Dit toepassingsgebied omvat uitgebreide steun voor belangrijke gebieden. <!--, such as Sites, Assets, Forms, Edge Delivery Services, Dynamic Media, and Cloud Manager. -->
