...
De minimaal vereiste Servlet API-versie is Servlet 3.1. Daarnaast ondersteunt AEM Forms Jakarta servlet 5 voor jar en war in toepassingsservers die Jakarta servlet API 5/6 implementeren.
