...
# De Stappen van de verbetering voor de Installaties van de Server van de Toepassing (Tomcat - Sidegrade) {#upgrade-steps-for-application-server-installations-tomcat}

>[!NOTE]
>
>Deze pagina schetst de verbeteringsprocedure van AEM 6.5 aan AEM 6.5 LTS op Tomcat. Voor bevordering van AEM 6.5 LTS aan AEM 6.5 LTS Servicepack [ verwijs dit ](/help/sites-deploying/app-server-upgrade-tomcat-inplace.md)
