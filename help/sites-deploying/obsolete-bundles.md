...
>[!NOTE]
>
>Als uw code op deze bundels vertrouwt, zorg ervoor u de Steun van Adobe contacteert en om een verenigbaarheidspakket voor het beïnvloede gebied vraagt.

Bij de upgrade naar AEM 6.3 worden de volgende bundels automatisch verwijderd, afhankelijk van de AEM-versie die de upgrade is uitgevoerd:
