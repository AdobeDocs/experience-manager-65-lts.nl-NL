...
U kunt de volgende instellingen voor dynamische media bewerken door in de component op **[!UICONTROL Edit]** te klikken en vervolgens op de tab **[!UICONTROL Dynamic Media Settings]** te klikken.
